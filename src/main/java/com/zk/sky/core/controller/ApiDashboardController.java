package com.zk.sky.core.controller;
...
import com.zk.sky.core.util.JavaDocReader;
...
public class ApiDashboardController {
    ...
    public Map<String, Object> dashboardMeta() {
        ...
        for (Map.Entry<RequestMappingInfo, HandlerMethod> entry : handlerMethods.entrySet()) {
            ...
            Set<String> patterns = com.zk.sky.core.util.SpringCompatUtils.getActivePatterns(mappingInfo);
